      ...
      <div class="d-lg-flex">
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
          ...
          <header class="navbar px-0 pb-4 mt-n2 mt-sm-0 mb-2 mb-md-3 mb-lg-4">
            <a href="index-2.html" class="navbar-brand pt-0">
          ...
          <div class="nav fs-sm mb-4">
            ...
            <a class="nav-link text-decoration-underline p-0 ms-2" href="http://localhost/Github/e-com/user/signup.php">Create an account</a>
          </div>
          ...
          <form class="needs-validation" novalidate="">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              ...
              <div class="nav">
                <a class="nav-link animate-underline p-0" href="http://localhost/Github/e-com/user/passwordrecovery.php?">
